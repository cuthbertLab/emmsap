...
def findSegmentsWithNoRatios(encodingType='DiaRhy2'):
    ...
    print("Got " + str(len(allSegmentIdsThatShouldHaveRatios)) + " segment ids that should have ratios")
...
def getRatiosForSegment(idOrSegment=1, dbObj = None, searchDirection = 'up', encodingType='DiaRhy2'):
    ...
    Use searchDirection = 'down' for adding to the database. Or 'both'.
